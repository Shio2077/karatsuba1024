...
HD_PWD='/home/hydrangea/project/AMD/karatsuba/karatsuba/karatsuba.runs/dsp_macro_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dsp_macro.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dsp_macro.tcl
