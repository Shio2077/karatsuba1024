...
#
# Generated by Vivado on Sun Jun 01 15:33:39 CST 2025
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"/tools/AMD/Vivado/2022.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"/tools/AMD/Vivado/2022.2/data/xilinx_vip/include" \
  ...
  vlogan -work blk_mem_gen_v8_4_5 $vlogan_opts +v2k +incdir+"/tools/AMD/Vivado/2022.2/data/xilinx_vip/include" \
    "$ref_dir/../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/tools/AMD/Vivado/2022.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../karatsuba.gen/sources_1/ip/blk_mem_gen_0/sim/blk_mem_gen_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/hydrangea/project/AMD/karatsuba/karatsuba/karatsuba.cache/compile_simlib/vcs"
  fi
