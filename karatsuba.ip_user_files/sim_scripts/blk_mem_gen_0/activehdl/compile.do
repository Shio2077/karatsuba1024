...
vlog -work xilinx_vip  -sv2k12 "+incdir+/tools/AMD/Vivado/2022.2/data/xilinx_vip/include" \
...
vlog -work xpm  -sv2k12 "+incdir+/tools/AMD/Vivado/2022.2/data/xilinx_vip/include" \
"/tools/AMD/Vivado/2022.2/data/ip/xpm/xpm_memory/hdl/xpm_memory.sv" \

vcom -work xpm -93  \
"/tools/AMD/Vivado/2022.2/data/ip/xpm/xpm_VCOMP.vhd" \

vlog -work blk_mem_gen_v8_4_5  -v2k5 "+incdir+/tools/AMD/Vivado/2022.2/data/xilinx_vip/include" \
"../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \

vlog -work xil_defaultlib  -v2k5 "+incdir+/tools/AMD/Vivado/2022.2/data/xilinx_vip/include" \
